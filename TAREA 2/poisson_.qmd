...
ggplot(data_ejemplo, aes(x = k, y = probabilidad, fill = color)) +
  ...
  theme_minimal() +
  scale_fill_manual(values = c("Normal" = "lightgray", 
                              "P(X = 6)" = "orange", 
                              "P(X = 0)" = "darkblue",
                              "P(X ≤ 3)" = "darkgreen")) +
...
ggplot(data_comp, aes(x = k, y = Probabilidad, fill = Tipo)) +
  ...
  scale_fill_manual(values = c("Teórica" = "darkblue", "Simulada" = "orange")) 
...
ggplot(data_suma_comp, aes(x = valores, fill = metodo)) +
  ...
  theme_minimal() +
  theme(legend.position = "top") +
  scale_fill_manual(values = c("X1 + X2" = "darkblue", "Poisson(λ1+λ2)" = "orange"))
```
...
ggplot(data_tcl, aes(x = media_muestral)) +
  geom_histogram(aes(y = after_stat(density)), bins = 30, alpha = 0.7, fill = "yellow") +
  geom_vline(xintercept = lambda_tcl, color = "red", linetype = "dashed", linewidth = 1) +
...
plots_comparacion <- lapply(names(data_tcl_split), function(label) {
  ...
  ggplot(datos, aes(x = media_muestral)) +
    geom_histogram(aes(y = after_stat(density)), bins = 25, alpha = 0.6, fill = "blue") +
...
ggplot(data_trafico, aes(x = paquetes, y = probabilidad, fill = zona)) +
  ...
  theme_minimal() +
  scale_fill_manual(values = c("Bajo" = "green", "Normal" = "darkblue", 
                              "Alto" = "darkorange", "Sobrecarga" = "red"))
```
...
ggplot(data_calidad, aes(x = defectos, fill = clasificacion)) +
  ...
  labs(title = "Simulación de Control de Calidad",
       ...
       fill = "Clasificación") +
  theme_minimal() +
  scale_fill_manual(values = c("Perfecto" = "green", "Aceptable" = "blue",
                              "Revisión" = "darkorange", "Rechazo" = "red"))
...
ggplot(data_epi, aes(x = casos, y = probabilidad, fill = escenario)) +
  ...
  theme_minimal() +
  scale_fill_manual(values = c("Sin intervención" = "pink", "Con intervención" = "green"))
```
...
ggplot(data_costos, aes(x = Inventario, y = Costo_Esperado)) +
  ...
  geom_vline(xintercept = nivel_optimo, linetype = "dashed", color = "green") +
